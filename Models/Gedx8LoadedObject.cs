...
namespace Gedx8MusicDriver.Models
{
    internal sealed class Gedx8LoadedObject
    {
        ...
        internal bool TryThinType2Query03F00(IntPtr queryContextPointer, string name)
        {
            if (!IsActive || Kind != Gedx8ObjectKind.ThinType2)
            {
                return false;
            ...
            if (_innerObject0C == null || queryContextPointer == IntPtr.Zero || string.IsNullOrWhiteSpace(name))
            {
                return false;
            }

            string? value;
            if (!_thinType2Mode0Values.TryGetValue(queryContextPointer.GetHashCode(), out value))
            {
            ...
            return _exportAnsiThinType2Query != IntPtr.Zero;
        }

        internal bool TryThinType2Query03F50(IntPtr queryContextPointer, string name)
        {
            if (!IsActive || Kind != Gedx8ObjectKind.ThinType2)
            {
                return false;
            ...
            string? value;
            if (!_thinType2Mode1Values.TryGetValue(queryContextPointer.GetHashCode(), out value))
            {
        ...
        internal bool TryThinType2Query03FA0(IntPtr descriptorPointer, string name)
        {
            if (!IsActive || Kind != Gedx8ObjectKind.ThinType2)
            {
                return false;
            ...
            string? value;
            if (!_thinType2Mode2Values.TryGetValue(descriptorPointer.GetHashCode(), out value))
            {
        ...
        internal bool TryThinType2Configure04020(int selector, int value, string? text)
        {
            ...
            string? effectiveText = text ?? LastStringValue ?? ResolvedPath ?? FileName;
            _thinType2Mode0Values[value] = effectiveText;
        ...
        internal bool TryThinType2Configure04070(int selector, int value, string? text)
        {
            ...
            string? effectiveText = text ?? LastOpenName ?? LastStringValue;
            _thinType2Mode1Values[value] = effectiveText;
            LastStringValue = effectiveText;
            return true;
        }
        ...
        internal bool TryThinType2Configure040D0(int selector, int value, string? text)
        {
            ...
            string? effectiveText = text ?? LastStringValue ?? LastOpenName;
            _thinType2Mode2Values[value] = effectiveText;
            LastStringValue = effectiveText;
            return true;
        }
